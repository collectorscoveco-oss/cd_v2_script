...
echo This PC is the host/bridge PC. On a gaming PC, tablet, or phone, open the URL shown below - do not use 127.0.0.1 on another device.
echo Host URL: %LAN_URL%
